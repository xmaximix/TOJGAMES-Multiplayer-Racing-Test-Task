...
namespace TojGamesTask.Modules.Lobby.Presentation
{
    ...
    {
        [field: SerializeField, Header("Login Panel")] public GameObject NamePanel { get; private set; }
        ...
        [field: SerializeField, Header("Lobby Panel")] public GameObject LobbyPanel { get; private set; }
